...
This source tree targets **Aliflix 3.1.38** (`versionCode 128`) for Android 10 and newer.
...
- Release page: [Aliflix 3.1.38](https://github.com/alishaban144/aliflix-android/releases/tag/v3.1.38)
- Direct APK: [aliflix-mobile.apk](https://github.com/alishaban144/aliflix-android/releases/download/v3.1.38/aliflix-mobile.apk)
