...
The current mobile release is **Aliflix 3.0.2** (`versionCode 82`) for Android 10 and newer.
...
5. Create and push the matching version tag, such as `v3.0.2`.
...
- Release page: [Aliflix 3.0.2](https://github.com/alishaban144/aliflix-android/releases/tag/v3.0.2)
- Direct APK: [aliflix-mobile.apk](https://github.com/alishaban144/aliflix-android/releases/download/v3.0.2/aliflix-mobile.apk)
