...
internal fun playbackSourceFallbacks(selection: PlaybackSelection, preferences: PlaybackPreferences): List<PlaybackSelection> =
    listOf(selection) + listOf(PlaybackProviderId.CINEJOY, PlaybackProviderId.MIRURO, PlaybackProviderId.ANIKURO, PlaybackProviderId.RAMOFLIX, PlaybackProviderId.DORABY, PlaybackProviderId.MOVIEPIRE)
